<template>
  <div>
    ...
    <el-table :data="projects" stripe >
      ...
      <el-table-column prop="host" label="所属项目"> </el-table-column>
      <el-table-column prop="max_threads" label="任务等级" width="100px">
      </el-table-column>
      <el-table-column prop="max_threads" label="用例数" width="100px">
        </el-table-column>
      <el-table-column prop="host" label="执行结果"> </el-table-column>
